  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
            Academic Control Card
          </h2>
          <p className="text-sm text-muted-foreground mt-1">
            Track your academic consultation progress
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <Button size="sm" onClick={handleDownloadPDF} className="shadow-sm">
      ...
      <Card
        ...
        ref={cardRef}
      >
        <CardContent className="p-8 space-y-6" id="control-card-printable">
          {showDetail && (
          ...
          <div className="flex flex-col items-center justify-center space-y-2">
            ...
            <h3 className="text-xl font-bold">
              TAHUN AJARAN: {studentInfo.tahun_akademik}
            </h3>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-12 gap-2">
              ...
              <div className="col-span-10">
                : {studentInfo.penasehat_akademik}
              </div>
            </div>
          </div>
                ...
                {controlEntries.map((entry) => (
                  <TableRow key={entry.no}>
                    ...
                    <TableCell className="text-center">
                      <Badge
                        variant={
                          entry.paraf === "Sudah" ? "success" : "outline"
                        }
                      >
                        {entry.paraf}
                      </Badge>
            ...
            <>
              ...
              <div className="space-y-2">
                <p className="font-bold">
                  Catatan: Sebelum Tanda Tangan Ketua Prodi, Mahasiswa
                  diwajibkan:
                </p>
                <ul className="list-disc pl-6 space-y-1">
                  <li className="font-medium">
                    Konsultasi ke Penasehat Akademik setiap Bulan Semester
                    Berjalan (Min. 5 kali)
                  </li>
                  <li className="font-medium">
                    Pengurusan Tanda Tangan dan Cetak KRS Online pada Awal
                    Semester Berjalan (1 Bulan awal Semester)
                  </li>
                  <li className="font-medium">
                    Pengisian Uraian Kartu Kontrol diisi oleh Mahasiswa pada
                    saat Konsultasi di Depan PA yang ditandai dengan Paraf PA
                  </li>
                  <li className="font-medium">
                    Point 1, 2, dan 3 wajib dipenuhi sebagai Syarat Pengambilan
                    Kartu UAS Semester Berjalan
                  </li>
                </ul>
              </div>
                ...
                <div className="flex justify-between items-center">
                  <div className="space-y-1">
                    <p className="text-sm font-medium">
                      ...
                      Jl. Sultan Alauddin No. 259 Telp. (0411) 866 972 Fax
                      (0411) 865 588 Makassar 90221
                      <br />
                      Web:{" "}
                      <a
                        href="https://if.unismuh.ac.id/"
