    ...
    const isChildActive =
      ...
      item.children.some(
        (child: any) =>
          isActive(child.href) ||
          (child.children &&
            child.children.some((grandchild: any) => isActive(grandchild.href)))
      );
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 bg-background/95 backdrop-blur-sm lg:hidden">
          ...
          <div className="flex border-b">
            <button className="flex-1 py-3 font-medium text-center border-b-2 text-primary border-primary">
              Menu
            </button>
          </div>
