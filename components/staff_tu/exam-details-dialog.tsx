...
export function ExamDetailsDialog({
  ...
  const [advisorType, setAdvisorType] = useState<"advisor1" | "advisor2">(
    "advisor1"
  );
  ...
  const handleRemoveCommitteeMember = (memberId: string) => {
    const updatedCommittee = editedExam.committee.filter(
  ...
  const handleAddAdvisor = (advisor: Advisor) => {
    ...
    toast({
      ...
      description: `${advisor.name} telah ditambahkan sebagai ${
        advisorType === "advisor1" ? "Pembimbing 1" : "Pembimbing 2"
      }.`,
    });
  };
  ...
  const handleRemoveAdvisor = (type: "advisor1" | "advisor2") => {
    ...
    toast({
      ...
      description: `${
        type === "advisor1" ? "Pembimbing 1" : "Pembimbing 2"
  ...
  return (
    <>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <Avatar className="w-12 h-12 border-2 border-primary/10">
                            <AvatarImage
                              src={editedExam.advisor1.avatarUrl}
                              alt={editedExam.advisor1.name}
                            />
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              {editedExam.advisor1.department}
                            </p>
                          </div>
                        </div>
                        {isEditing && (
                    ...
                    {editedExam.advisor2 ? (
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <Avatar className="w-12 h-12 border-2 border-primary/10">
                            <AvatarImage
                              src={editedExam.advisor2.avatarUrl}
                              alt={editedExam.advisor2.name}
                            />
                            <AvatarFallback className="bg-primary/10 text-primary">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              {editedExam.advisor2.department}
                            </p>
                          </div>
                        </div>
                        {isEditing && (
      ...
      <CommitteeMemberDialog
        ...
        description={`Pilih dosen untuk ditugaskan sebagai ${
          advisorType === "advisor1" ? "Pembimbing 1" : "Pembimbing 2"
        } pada ujian ini`}
      />
    </>
